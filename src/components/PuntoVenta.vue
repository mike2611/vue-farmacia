              ...
              <div class="d-flex flex-row align-items-center justify-content-around">
                <div>
                  ...
                  <div class="list-wrapper">
                    <ul class="list-group m-3" v-if="productos.length <= 5">
                      <li
                ...
                <div>
                  <div class="ml-4">
                    <span class="blue-color font-weight-bold"
                      >{{ cuenta.length > 0
                        ? "Cuenta Actual:"
                        : "Aún no agrega ningún producto a su cuenta" }}</span
                    >
                    <div class="d-flex">
                      <ul class="list-group m-3">
                        <li
      ...
      <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">Si tiene una venta en proceso, se perderá si sale.</div>
    ...
    data() {
        return{
            productos: [
                ...
                {nombre: 'Complejo A', descripcion: '500mgs', precio_venta: 150},
                {nombre: 'Complejo C', descripcion: '500mgs', precio_venta: 200},
